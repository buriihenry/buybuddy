  ...
  return (
    <div className="mb-10 lg:mb-20 bg-tech_light_blue p-5 lg:p-7 rounded-md">
      <div className="flex items-center gap-5 justify-between mb-10">
        ...
        <Link
          href={"/shop"}
          className="text-sm font-semibold tracking-wide hover:text-tech_light_blue hoverEffect"
        >
          View all
        </Link>
      </div>
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-2.5">
        {brands?.map((brand) => (
          <Link
            ...
            className="bg-white w-34 h-24 flex items-center justify-center rounded-md overflow-hidden hover:shadow-lg shadow-tech_light_blue/20 hoverEffect"
          >
            {brand?.image && (
              <Image
